<?php
// backend/geocercas/actualizar_foto_salida.php
...
logDebug("=== ACTUALIZAR FOTO SALIDA ===");
...
try {
    ...
    $sql = "UPDATE registros_geocerca 
            SET foto_salida = ?, fecha_captura_salida = ? 
    ...
    if ($stmt->execute()) {
        logDebug("✅ Foto de salida actualizada exitosamente");
        sendJsonResponse([
            'success' => true,
            'message' => 'Foto de salida actualizada',
